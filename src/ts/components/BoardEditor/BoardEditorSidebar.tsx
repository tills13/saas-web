...
import { CellExtraOptions, CellOption } from "."
...
class BoardEditorSidebar extends React.Component<BoardEditorSidebarProps, BoardEditorSidebarState> {
  ...
  onInputChanged = (name: keyof Models.Board[ "configuration" ], parseValue: undefined | ((value: string) => any), event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      <div className="BoardEditorSidebar">
        <form className="">
          ...
          <TextInput
            ...
            onChange={ this.onInputChanged.bind(null, "name", undefined) }
          />
